...
// go test -v -run="TestGetChangeBill$" -args private_key.pem mchid serial_no out_batch_no <out_detail_no>
func TestGetChangeBill(t *testing.T) {
	numArgs := len(os.Args)
